" Vundle        is a shortcut for Vim Bundle and Is a simple plugin manager for nim
" Author:       seriki-yakub
" HomePage:     http://github.com/Vundle-Vim/Vun.nim
" Readme:       http://github.com/web4application/vun/blob/main/README.md
" Version:      0.10.2
...
" Initialize some global variables used by Vundle.
    let vundle#bundle_dir = expand('$HOME/.nim/bundle', 1)
let vundle#bundles = []
